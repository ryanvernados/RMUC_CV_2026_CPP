/workspace/aimbot_cpp/RMUC_CV_2026_C-/bin/calibur_worker: \
  ...
  /usr/lib/gcc/aarch64-linux-gnu/13/../../../aarch64-linux-gnu/libnvonnxparser.so \
  /workspace/aimbot_cpp/RMUC_CV_2026_C-/apps/yaml-cpp/lib/libyaml-cpp.a \
  /usr/lib/aarch64-linux-gnu/libopencv_highgui.so.4.6.0 \
  /usr/lib/aarch64-linux-gnu/libopencv_videoio.so.4.6.0 \
  /usr/lib/aarch64-linux-gnu/libopencv_imgcodecs.so.4.6.0 \
  /usr/lib/aarch64-linux-gnu/libopencv_calib3d.so.4.6.0 \
  /usr/lib/aarch64-linux-gnu/libopencv_features2d.so.4.6.0 \
  /usr/lib/aarch64-linux-gnu/libopencv_imgproc.so.4.6.0 \
  /usr/lib/aarch64-linux-gnu/libopencv_flann.so.4.6.0 \
  ...
  /lib/aarch64-linux-gnu/libavcodec.so.60 \
  /lib/aarch64-linux-gnu/libavformat.so.60 \
  /lib/aarch64-linux-gnu/libavutil.so.58 \
  /lib/aarch64-linux-gnu/libswscale.so.7 \
  ...
  /opt/MVS/lib/aarch64/libusb-1.0.so.0 \
  ...
  /lib/aarch64-linux-gnu/libswresample.so.4 \
  ...
  /lib/aarch64-linux-gnu/libmbedcrypto.so.7 \
  ...
  /usr/lib/aarch64-linux-gnu/nvidia/libnvrm_surface.so \
